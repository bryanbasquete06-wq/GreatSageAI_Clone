...
# -*- coding: utf-8 -*-
"""
Great Sage AI — Setup Wizard (Installer GUI v2)
=================================================
Complete setup wizard for end users:
  ...
  4. Select voice (Raphael, Natural, Jarvis)
...
class InstallerWindow(QMainWindow):
    """Complete setup wizard for Great Sage AI."""
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Great Sage AI — Setup Wizard")
    ...
    def _build_pages(self):
        ...
        p0.desc_label.setText(
            "O assistente vai verificar se seu computador tem tudo necessário para rodar o Grande Sábio."
        )
        ...
        p3.desc_label.setText(
            "Escolha a voz do Grande Sábio. Você pode mudar depois nas configurações."
        )

        voices = [
            ("raphael", "Raphael — Voz Feminina Calma (Recomendado)", "pt-BR-FranciscaNeural"),
        ...
        self.wake_input = QLineEdit("Ok Grande Sabio")
        ...
        p5.desc_label.setText(
            "Tudo pronto! O assistente vai testar o sistema de voz e iniciar o Grande Sábio."
        )
    ...
    def _run_save_keys(self):
        ...
        # Save to .env
        env_path = self._project_dir / ".env"
        env_content = f"# Great Sage AI — Environment Variables\n"
    ...
    def _run_create_shortcuts(self):
        ...
        def worker():
            ...
            self.shortcut_info.setText(
                ...
                f"  • Grande Sabio AI.bat\n"
                f"  • Instalador Great Sage.bat"
            )
    ...
    def _run_final_launch(self):
        ...
        def worker():
            ...
            # Launch AI
            self._log("Iniciando Grande Sábio...", GOLD)
            self.test_info.setText("🚀 Iniciando Grande Sábio...")
            ...
            try:
                ...
                if main_py.exists():
                    ...
                    self._log("✓ Grande Sábio iniciado!", GREEN)
                    self.test_info.setText(
                        "🎉 Instalação concluída!\n\n"
                        "O Grande Sábio foi iniciado.\n"
                        "Use 'Ok Grande Sabio' para ativar por voz.\n"
